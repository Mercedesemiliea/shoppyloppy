...
<body>
    ...
    <div class="register-thanks-container">
        ...
        <p>Tack för att du registrerade dig. <?= htmlspecialchars($_SESSION['username']); ?>  Du är nu en del av en fantastisk gemenskap som delar ditt intresse för Pokémons.</p>
